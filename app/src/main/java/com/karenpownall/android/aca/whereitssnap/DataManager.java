...
public class DataManager {
    ...
    /* next we have public static final string for each row/table
    ...
    /* next we have a private static final strings for each row/table
    that we need to refer to just inside this class
     */
    ...
    public DataManager(Context context){
        //create instance of internal //CustomSQLiteOpenHelper class
    ...
    //here are all helper methods
    public void addPhoto(Photo photo){
        //add all details to the photos table
    ...
    //this class is created when DataManager is initialized
    private class CustomSQLiteOpenHelper extends SQLiteOpenHelper{
        ...
        // method only runs when we increment DB_VERSION
        @Override
    ...
    } //end CustomSQLiteOpenHelper inner class

} //end DataManager.java
